...
import Paypal from './generales/Paypal'
const Cart = () => {
    ...
    useEffect(() => {
        ...
        let datos = dispatch(ProductosAction.obtenerProductos())
        datos.then(res => setProductos(res))
    }, [reload])


    canasta?.forEach((id) => {
        renderProd.push(
            ...productos.filter((productos) => productos.id_productos == id)
        );
    });
    let newArray = renderProd.reduce(function (accumulator, curValue) {
        return accumulator.concat(curValue)
    }, []

    )
    let total = newArray.reduce(function (acc, curValue) {
         return acc + curValue.precio
        }, 0)
        console.log(total)
    return (
        <div className="h-min w-full  bg-[#f7f7f7] ">
            ...
            <div className="min-h-screen bg-[#f7f7f7] ">
                <div className="py-12">
                    ...
                    <div className="max-w-md mx-auto bg-[#f7f7f7] transform -translate-y-60 shadow-lg rounded-lg  md:max-w-5xl">
                        <div className="md:flex ">
                            <div className="w-full p-4 px-5 py-5 bg-white rounded-lg">
                                ...
                                <div className="md:grid md:grid-cols-3 gap-2 ">
                                    ...
                                    <div className="col-span-2 p-5">
                                        ...
                                        {newArray?.map((item, index) => <ItemCart item={item} key={index} />)}

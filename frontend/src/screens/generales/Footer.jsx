...
function Footer() {
  return (
        ...
        <div class="grid grid-cols-1 gap-8 mt-16 lg:grid-cols-2 lg:gap-32">
            ...
            <p class="text-black text-2xl font-bold uppercase">
            Remecycle
            </p>
        
            <p class="mt-4 text-center text-black lg:text-left lg:text-lg">
            ...
            <div
                class="flex justify-center gap-4 mt-6 text-gray-300 lg:justify-start"
            >
                <a
            ...
            >
            <div>
                <strong class="text-sm font-bold tracking-wide text-black uppercase">
                Services
                </strong>
        
                <nav class="flex flex-col mt-6 space-y-1 text-gray-600">

...
const Login = () => {
  ...
  return (
    <div className='w-full py-10 bg-slate-400'>
           <div className='max-w-[1071px] min-h-[741px] p-10 rounded-md bg-white flex flex-row  items-center justify-between mx-auto '>
